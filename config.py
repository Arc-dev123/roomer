...
items = [
            ["🥶 A/C", "It's really chilly, maybe keep the temperature down!", 2, 5, "ac"],
            ["👗 Clothes Valet", "Maybe keep your favorite dress up here to make all your friends jealous!", 4, 10, "clothes_valet"],
